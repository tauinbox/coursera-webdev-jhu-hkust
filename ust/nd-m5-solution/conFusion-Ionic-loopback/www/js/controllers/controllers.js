...
.controller('MenuController', ['$scope', '$rootScope', 'Dishes', 'Favorites', 'baseURL', '$ionicListDelegate', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function ($scope, $rootScope, Dishes, Favorites, baseURL, $ionicListDelegate, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
...
.controller('DishDetailController', ['$scope', '$rootScope', '$state', '$stateParams', 'Dishes', 'Favorites', 'Comments', 'baseURL', '$ionicPopover', '$ionicModal', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', '$cordovaSocialSharing', function ($scope, $rootScope, $state, $stateParams, Dishes, Favorites, Comments, baseURL, $ionicPopover, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast, $cordovaSocialSharing) {
    ...
    $scope.addFavorite = function () {
        ...
        Favorites.create({customerId: $rootScope.currentUser.id, dishesId:  $stateParams.id});
        $scope.popover.hide();
...
.controller('IndexController', ['$scope', 'Dishes', 'Promotions', 'Leaders', 'baseURL', function ($scope, Dishes, Promotions, Leaders, baseURL) {
    ...
    Promotions.findOne({"filter":{"where":{
            "featured": "true"
        }}})
    .$promise.then(
            function (response) {
